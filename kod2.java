...
public class kod2 {
    public static void main(String[] args) {
        ...
        //Сохраняем введенное значение в переменную n.
        ...
        //Сохраняем введенные элементы в массив array с помощью цикла for.
        for (int i = 0; i < n; i++) {
    ...
    //Выводит элементы массива на экран, разделяя их пробелами.
